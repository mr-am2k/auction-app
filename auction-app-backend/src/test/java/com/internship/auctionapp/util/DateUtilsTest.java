...
class DateUtilsTest {
    ...
    public void DateUtil_date_difference_in_years_ok(){
        DateUtils.currentDateTime = LocalDateTime.of(2022, 11, 17, 12, 12 ,12);
        LocalDateTime newDateTime = LocalDateTime.of(2024, 12, 12, 12 ,12, 12);
        assertEquals("2 years", DateUtils.calculateDateDiffVerbose(newDateTime));
    }
    ...
    public void DateUtil_date_difference_in_months_ok(){
        ...
        assertEquals("9 months", DateUtils.calculateDateDiffVerbose(newDateTime));
    }
    ...
    public void DateUtil_date_difference_in_weeks_and_days_ok(){
        ...
        assertEquals("3 weeks 5 days", DateUtils.calculateDateDiffVerbose(newDateTime));
    }
    ...
    public void DateUtil_date_difference_in_days_ok(){
        ...
        assertEquals("5 days", DateUtils.calculateDateDiffVerbose(newDateTime));
    }
    ...
    public void DateUtil_date_difference_in_hours_and_minutes_ok(){
        ...
        assertEquals("1 hour 56 minutes", DateUtils.calculateDateDiffVerbose(newDateTime));
    }
    ...
    public void DateUtil_date_difference_in_minutes_and_seconds_ok(){
        ...
        assertEquals("12 minutes 58 seconds", DateUtils.calculateDateDiffVerbose(newDateTime));
    }
    ...
    public void DateUtil_date_difference_in_seconds_ok(){
        ...
        assertEquals("10 seconds", DateUtils.calculateDateDiffVerbose(newDateTime));
    }
    ...
    public void DateUtil_date_is_before(){
        ...
        assertEquals(true, DateUtils.isInPast(newDateTime));
    }
    ...
    public void DateUtil_date_is_after(){
        DateUtils.currentDateTime = LocalDateTime.of(2022, 11, 17, 12, 12, 12);
        LocalDateTime newDateTime = LocalDateTime.of(2022, 11, 17, 12, 12 ,22);
        assertEquals(false, DateUtils.isInPast(newDateTime));
    }
}