...
class RegexUtilsTest {
    ...
    public void RegexUtils_returns_false_when_email_is_null() {
        final boolean validate = RegexUtils.match(RegexUtils.VALID_EMAIL_ADDRESS_REGEX, null);
    ...
    public void RegexUtils_throws_exception_when_password_is_null() {
        final boolean validate = RegexUtils.match(RegexUtils.VALID_PASSWORD_REGEX, null);
