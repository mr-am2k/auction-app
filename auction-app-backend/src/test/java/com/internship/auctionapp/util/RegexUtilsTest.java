...
class RegexUtilsTest {
    ...
    public void RegexUtils_runs_correctly_when_email_is_valid(){
        final boolean validate = RegexUtils.match(RegexUtils.VALID_EMAIL_ADDRESS_REGEX, "user@gmail.com");

        assertEquals(true, validate);
    }

    @Test
    public void RegexUtils_throws_error_when_email_is_null(){
        final NullPointerException thrown = Assertions.assertThrows(NullPointerException.class, () -> {
            RegexUtils.match(RegexUtils.VALID_EMAIL_ADDRESS_REGEX, null);
    ...
    public void RegexUtils_returns_false_when_email_is_not_valid(){
        final boolean validate = RegexUtils.match(RegexUtils.VALID_EMAIL_ADDRESS_REGEX, "usergmail.com");
    ...
    public void RegexUtils_returns_false_when_email_is_empty_string(){
        final boolean validate = RegexUtils.match(RegexUtils.VALID_EMAIL_ADDRESS_REGEX, "");
    ...
    public void RegexUtils_runs_correctly_when_password_is_valid(){
        final boolean validate = RegexUtils.match(RegexUtils.VALID_PASSWORD_REGEX, "Pa$$w0rd");
    ...
    public void RegexUtils_throws_exception_when_password_is_null(){
        final NullPointerException thrown = Assertions.assertThrows(NullPointerException.class, () -> {
            RegexUtils.match(RegexUtils.VALID_PASSWORD_REGEX, null);
        }, "NullPointerException was expected");
    ...
    public void RegexUtils_returns_fals_when_password_has_less_than_8_characters(){
        final boolean validate = RegexUtils.match(RegexUtils.VALID_PASSWORD_REGEX, "Pa$$w0");
    ...
    public void RegexUtils_returns_false_when_password_is_without_number(){
        final boolean validate = RegexUtils.match(RegexUtils.VALID_PASSWORD_REGEX, "Pa$$word");
    ...
    public void RegexUtils_returns_false_when_password_is_without_symbol(){
        final boolean validate = RegexUtils.match(RegexUtils.VALID_PASSWORD_REGEX, "Passw0rd");
