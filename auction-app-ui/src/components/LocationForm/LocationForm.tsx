...
const LocationForm: React.FC<Props> = ({ user, required }) => {
  ...
  const children = [
    <Input
      ...
      placeholder={user?.address?.street || ADDRESS_FORM.STREET_PLACEHOLDER}
    ...
    <Input
      ...
      placeholder={user?.address?.city || ADDRESS_FORM.CITY_PLACEHOLDER}
    ...
    <Input
      ...
      placeholder={user?.address?.zipCode || ADDRESS_FORM.ZIP_CODE_PLACEHOLDER}
    ...
    <Input
      ...
      placeholder={user?.address?.state || ADDRESS_FORM.STATE_PLACEHOLDER}
    ...
    <Input
      ...
      placeholder={user?.address?.country || ADDRESS_FORM.COUNTRY_PLACEHOLDER}
